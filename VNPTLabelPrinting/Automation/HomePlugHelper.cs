...
namespace Automation {
    public class HomePlugHelper : IDisposable {

        string port_name = "";
        int baud_rate = 115200;
        SerialPort dut = null;

        public HomePlugHelper(string port, string baud) {
            this.port_name = port;
        ...
        public string getUid(out string message) {
            ...
            RE:
                count++;
                dut.WriteLine("Custom plug_turn_off_log_off 0xAAAA");
                Thread.Sleep(1000);
            ...
            END:
                dut.WriteLine("custom plug_turn_off_log");
                Thread.Sleep(1000);
                data = dut.ReadExisting();
                message += data;
                return eui;
